		...
		<div class="container">
			  ...
			  <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
				<ul class="nav navbar-nav">
                    ...
                    <li><a href="#profile">Filitre</a></li>
					<li><a href="#profile">Profilim</a></li>
					<li><a href="#friendRequests">Profilimi Begenenler</a></li>
					<li><a href="#messages">Mesajlar</a></li>
					<li><a href="#contact">İletisim</a></li>
					<li><a href="#exit">Cikis</a></li>
				</ul>
			  </div>
		</div>
	</nav>
...
<div id="package">
	<div class="container">
		<div class="text-center">
			<!-- /.pricing title -->
			<h2 class="wow fadeInLeft">Onerilen Kisiler</h2>
			...
			<div class="col-sm-3">
			  <div class="price-box wow fadeInUp">
			   ...
			   <!-- /.package icon 
					...
					<center><img alt="client" src="images/adembavas.jpg" class="wow fadeInUp"></center>
...
<!-- /.contact section -->
<div id="contact">
	<div class="contact fullscreen parallax" style="background-image:url('images/woman-642118.jpg');" data-img-width="2000" data-img-height="1334" data-diff="100">
		<div class="overlay">
			<div class="container">
				<div class="row contact-row">
					...
					<div class="col-sm-5 contact-left wow fadeInUp">
						<h2><span class="highlight">Bize</span> Yazın</h2>
							<ul class="ul-address">
